...
def load_config(env_file: str = ".env") -> AppConfig:
    ...
    return AppConfig(
        ...
        data_pickle_path=_env_str("DATA_PICKLE_PATH", "anli_text_classification_data.pickle"),
        ...
        logging_dir=_env_str("LOGGING_DIR", "logs"),
        eval_report_path=_env_str("EVAL_REPORT_PATH", "eval_report.json"),
